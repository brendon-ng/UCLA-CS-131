...
class Client:
    def __init__(self, server='Hill', ip='127.0.0.1', port=8888, name='client', message_max_length=1e6):
        """
...
if __name__ == '__main__':
    ...
    client = Client(server=sys.argv[1])  # using the default settings
